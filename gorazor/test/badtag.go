...
func RenderBadtag(_buffer io.StringWriter, w *gorazor.Widget) {
	if w.ErrorMsg != "" {
		...
		_buffer.WriteString(gorazor.HTMLEscStr(w.ErrorMsg))
	...
	_buffer.WriteString("\n\n\t<label for=\"")
	_buffer.WriteString(gorazor.HTMLEscStr(w.Name))
	_buffer.WriteString("\">")
	_buffer.WriteString(gorazor.HTMLEscStr(w.Label))
	_buffer.WriteString("</label>\n\t<input type=\"text\" name=\"")
	_buffer.WriteString(gorazor.HTMLEscStr(w.Name))
	_buffer.WriteString("\" class=\"form-control\" id=\"")
	_buffer.WriteString(gorazor.HTMLEscStr(w.Name))
	_buffer.WriteString("\" placeholder=\"")
	_buffer.WriteString(gorazor.HTMLEscStr(w.PlaceHolder))
	_buffer.WriteString("\" value=\"")
	_buffer.WriteString(gorazor.HTMLEscStr(w.Value))
	_buffer.WriteString("\">\n</div>")
